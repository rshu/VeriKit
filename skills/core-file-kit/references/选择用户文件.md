...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/90/v3/FHZn2UfOTva3TEneRyVFLg/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111000Z&HW-CC-Expire=86400&HW-CC-Sign=318BC6178EF5589D4541D26B859CD76263FF8FCF8C5323B5D9D87E5349215069)
1.
...
2.
创建音频类型文件选择选项实例。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/88/v3/Mqc9JtclTWKEBPc1vHAndg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111000Z&HW-CC-Expire=86400&HW-CC-Sign=5759AC524CE909C64EF5C15BFC1AA42F38815BA0863F4EEB917B6C88CF367158)
目前AudioSelectOptions不支持参数配置，默认可以选择所有类型的用户文件。
```
const audioSelectOptions = new picker.AudioSelectOptions();
```
3.
创建音频选择器 [AudioViewPicker](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#audioviewpicker) 实例。调用 [select()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#select-5) 接口拉起AudioPicker应用界面进行文件选择。
```
let uris: string[] = [];
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/dd/v3/rrxJ-9tGQ6Wv1KnOzllqaw/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111000Z&HW-CC-Expire=86400&HW-CC-Sign=DF4730A6FFDCF0D06F377101E74FF29BE54761A9FB841F883BF8260CEB75B339)
1.
使用Picker获取的 [select()](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#select-3) 返回的URI权限是临时只读权限，待退出应用后台后，获取的临时权限就会失效。
2.
如果想要获取持久化权限，请参考 [文件持久化授权访问](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/file-persistpermission#通过picker获取临时授权并进行授权持久化) 。
