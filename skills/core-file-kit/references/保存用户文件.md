...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b6/v3/K6ZDg_qyS8GVgv3c7WlcjA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111000Z&HW-CC-Expire=86400&HW-CC-Sign=E309EC6AD7CD599EB306FE1FA05D1F058F6D96571150BA8A23A3C15C9DC30908)
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a0/v3/0ewIiHSjSImSLDEku58yiQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111000Z&HW-CC-Expire=86400&HW-CC-Sign=2CFEFEF1528CF2F4A250B5D754303DA5B64C545F8A40FBE9D208B16DE8CF4F8B)
- Picker会默认[预置空文件](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-picker#documentsaveoptions)并返回保存文件的URI数组，应用拿到URI后可使用[文件管理](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-file-fs)模块的接口进行文件读写操作。
- 避免在Picker回调中直接操作URI。
- 建议使用全局变量保存URI以供后续使用。
- 可以通过[DOWNLOAD模式](#download模式保存文件)直达下载目录。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e4/v3/6dQlhnmLQgWQZs4M0b0W6Q/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111000Z&HW-CC-Expire=86400&HW-CC-Sign=E74B22D45F94CB4DB4B204F105740DCE924D0EECA6A2F6278AAA38BC3914923A)
