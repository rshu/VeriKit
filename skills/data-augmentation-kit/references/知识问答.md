...
#### 接口说明
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2f/v3/_1xSyybmTCaGj3kPcaXZsg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111003Z&HW-CC-Expire=86400&HW-CC-Sign=366217334A362C4F90438FD926D5FC7DB20D53339DDE138E7885391F38FBC53A)
接口需在页面或自定义组件生命周期内调用。
...
```
2.
创建http工具类，用以和大模型交互，用户也可选择webSocket（可参考 [Network Kit](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/network-api-arkts) ）或者其他方式与大模型交互。本示例选用了 [ModelArts平台](https://console.huaweicloud.com/modelarts) 的qwen3-235b-a22b模型作为示例，开发者使用时需根据实际情况选择合适大模型。示例代码包括如下三个环节：
...
-
[RetrievalConfig](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataaugmentation-retrieval-api#retrievalconfig)
...
```
-
[RetrievalCondition](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataaugmentation-retrieval-api#retrievalcondition)
[知识加工](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/data-augmentation-knowledge-processing)
```typescript
...
```
-
[ChatLLM](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/dataaugmentation-rag-api#chatllm)
```typescript
import { rag } from "@kit.DataAugmentationKit";
...
```
#### 流式问答调用流程图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/bcblf_QlRhu90KpZtx5J9Q/zh-cn_image_0000002543214314.png?HW-CC-KV=V1&HW-CC-Date=20260421T111003Z&HW-CC-Expire=86400&HW-CC-Sign=7244D4004BB1C984CEBE0FD0AA0046E30DC8FA8D8B0164F34B7B3F12E102C76D)