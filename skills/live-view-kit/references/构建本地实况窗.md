...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/HZ_ffjN9Q6audLT1EPSe6Q/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=93B1CE1E25A25AF05981AE774193D4C6F7278024300E6D02FDAE6CB5C7BC6C0B)
...
#### 进度可视化模板
进度可视化模板适用于打车、外卖等场景。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6b/v3/k_x7aUnUQ6GUTZ1ien9lGw/zh-cn_image_0000002573854925.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=2CBC44D6F563651659464137BEE1663583E840EACCC97F61860FDB404B6A405F)
示例代码如下：
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1e/v3/BWkYn91ZQQS7Xir6es1A7g/zh-cn_image_0000002573974905.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=E6B1FDB49C4D1C452022BE688E192FDE9567F1D2498D099FB40A12C8D8F3FD3B)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/72/v3/uaxuef8jS52RGE-uKBN1-A/zh-cn_image_0000002543374674.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=0D00A457725EEBEF1732D8C526749EEA230D0EFC94F8A60A757C8D7A4D6DCF44)
代码示例如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
#### 强调文本模板
强调文本模板适用于取餐、排队等场景。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/w60N-0pSS-awQ83NBvecmA/zh-cn_image_0000002543215012.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=18B28E3DFF330BC00C6D83004C8362195BA895B8FCEF119C6AECE7FF5F09A2E8)
示例代码如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/05/v3/DUv_bZogRKG3lUsrBETGiA/zh-cn_image_0000002573854927.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=29A3F86AC126FAB15D4A2C4ED08D4727308DB59CFCFFC5CB1396FC384DD9441D)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a1/v3/hopX6OxARvmJFUGC4cUVSg/zh-cn_image_0000002573974907.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=8C7F87F8CFC2338D9E1F158F5BEFFC2D375D484E65352B045622CB4B6C842033)
代码示例如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
#### 左右文本模板
左右文本模板适用于高铁、航班等场景。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c2/v3/EgwVi2L1SU2Z9roW7eYDHw/zh-cn_image_0000002543374676.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=AF313A63278270E58C3A5429EED8F8B4CACEA2E97A003F3294F525FBC8977F8C)
示例代码如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/kWuz0Fk_Tge-hDXSqw6vow/zh-cn_image_0000002543215014.gif?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=D68088B3542DF7C065715CC4AC5548285E6AC15A0C7AF7E6D0893077AD083DE9)
代码示例如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
#### 赛事比分模板
赛事比分模板适用于赛事场景。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/_aogvnAaRMqKAIuoeuSKug/zh-cn_image_0000002573854929.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=538221FB5F7AD4835BAAAE86B60B1811B349A69E94C60BEA18D04803F09924E1)
示例代码如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
#### 导航模板
导航模板适用于出行导航场景。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/Bn5tpc-BQJeohaf6C55BMw/zh-cn_image_0000002573974909.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=54E248FBB6045A309E31D39CC2A27F9A24068E2A699C41BE1237E4DD30F4B9F8)
示例代码如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/97/v3/AR2hvbMMS4GPyCghFCt5PA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=C87558E8531664E4370820E9DA8DA3FB27DBC1A7359D70D13C971CB6F22AA092)
...
#### 实况胶囊
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/4a/v3/oxqnGR1uRCGTbKLg01AgeQ/zh-cn_image_0000002543374678.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=FEF356FC05FE3177CF2733CA4237F65C8BB41FBF7BA72DD0156E07E5E36C6DB3)
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/7uFwmX4vRBmvkepy75cbEw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=01C4DD681F62B8508F71141654F3B9FBC518C33B268A57B4CFAA9F319B065055)
...
```
#### 小折叠外屏实况窗
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/62/v3/udz2HCPdTyaqpU5dxlStIw/zh-cn_image_0000002543215016.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=423F3A6599564758AD0084BEBF48BC874DC8680C43D345F3E8639ED036A5E456)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/94/v3/nCZ2I_wzQ2um-Ulzr9QQiA/zh-cn_image_0000002573854931.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=6BD646C14AE324CD2DBB76FA51DAC4C582001E1793B1801CFC0DCD541C1AFBD5)
示例代码如下：
构建LiveViewController后，请在代码中初始化LiveViewController并调用LiveViewController.startLiveView()方法。
```typescript
import { liveViewManager } from '@kit.LiveViewKit';
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/47/v3/LMkZzcjxTdS2-qmqYZmuww/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111550Z&HW-CC-Expire=86400&HW-CC-Sign=56B3D011A2A70596E94C4441ABFD30F7F70DD24516A39A26EDAF5F8FACAD6CC2)
