...
效果如图所示。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/65/v3/Uk_JSG-iRJ6B6ztlE_xbwg/zh-cn_image_0000002543374300.gif?HW-CC-KV=V1&HW-CC-Date=20260421T111346Z&HW-CC-Expire=86400&HW-CC-Sign=7B3A3373CDB0EAEBFF133C916EF227F6BAD63BF56A2F5ED4B815E95F5773B0FC)
#### 开发步骤
1.
导入选择器模块和文件管理模块。
```
...
效果如图所示。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/1hd4UAUmR2O7UbJ4hit9fA/zh-cn_image_0000002543214638.gif?HW-CC-KV=V1&HW-CC-Date=20260421T111346Z&HW-CC-Expire=86400&HW-CC-Sign=DB67D67EAFF579843738FE68095E76ABB20B7CBE134600CB8B5764062FFA5B75)
#### 开发步骤
1.
导入选择器模块和文件管理模块。
```
