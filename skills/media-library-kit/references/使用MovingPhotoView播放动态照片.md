...
1.
导入动态照片模块。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7e/v3/0DpalIGUTmqz9WL9P1sHLw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111347Z&HW-CC-Expire=86400&HW-CC-Sign=7C02DEF7221E69DEF49DC27E36C3510D98FC97891F4E7367DABE802C7886429F)
...
```
2.
获取动态照片对象（ [MovingPhoto](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arkts-apis-photoaccesshelper-movingphoto) ）。
...
```
3.
创建动态照片控制器（ [MovingPhotoViewController](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/ohos-multimedia-movingphotoview#movingphotoviewcontroller) ），用于控制动态照片的播放状态（如播放、停止）。
```
...
```
#### 效果展示
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/87/v3/c2PAtYRPQD-dQCIRtxD9qw/zh-cn_image_0000002543374302.gif?HW-CC-KV=V1&HW-CC-Date=20260421T111347Z&HW-CC-Expire=86400&HW-CC-Sign=5966B9D9BE92F5C1C47D56521C2A0CF94E8540703E4E76EA8EA802775FF38F5D)