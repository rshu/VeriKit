...
视频编解码的逻辑如图所示。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/21/v3/07Y1MjYSQ8K27pnGmgVeuw/zh-cn_image_0000002543374232.png?HW-CC-KV=V1&HW-CC-Date=20260421T111306Z&HW-CC-Expire=86400&HW-CC-Sign=D8CA6E17339D24911D0404D03EA9EF9EE30FB690E6B0BEF73683C7EB6D2175BD)
...
在编码和解码过程中，通过回调函数通知应用数据处理的情况；如编码过程通过回调通知应用，完成一帧编码，输出编码结果AVBuffer；在解码过程通过回调通知应用输入一帧码流到解码器解码，当解码完成也会通过回调通知应用解码完成，应用可以对数据做后续处理。
音频编解码逻辑如图所示。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fa/v3/zekVaeoyR32AMew5aFjlhQ/zh-cn_image_0000002543214570.png?HW-CC-KV=V1&HW-CC-Date=20260421T111306Z&HW-CC-Expire=86400&HW-CC-Sign=EB475CCDDEF61C7C4958806FDCF4B07D3237F9CC3D1B0EDBF67E22C5F58DFAF6)
...
文件封装解封装逻辑如图所示。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3b/v3/I3fGSzMPRaCHcIX-8OgUoA/zh-cn_image_0000002573854485.png?HW-CC-KV=V1&HW-CC-Date=20260421T111306Z&HW-CC-Expire=86400&HW-CC-Sign=565EDD29F22746C3388E79D7FE721A431AAEF7588B7851C6574271A8D438E66F)
