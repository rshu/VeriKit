...
| [HMS_AREngine_ARFaceBlendShapes_AcquireData](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arengine-capi-arengine#hms_arengine_arfaceblendshapes_acquiredata) | 获取人脸混微表情数据的集合。 |
| [HMS_AREngine_ARFaceBlendShapes_AcquireTypes](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/arengine-capi-arengine#hms_arengine_arfaceblendshapes_acquiretypes) | 获取所有表达式参数类型数组。 |
