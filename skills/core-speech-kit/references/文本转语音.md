...
```
5.
（可选）当需要查询文本转语音服务是否处于忙碌状态时，可调用 [isBusy](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/hms-ai-texttospeech#isbusy) 接口。
```typescript
ttsEngine.isBusy();
```
6.
（可选）当需要查询支持的语种音色信息时，可调用 [listVoices](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/hms-ai-texttospeech#listvoices) 接口。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d9/v3/ov2-EXG9S8WJpzWrNrwGfg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111932Z&HW-CC-Expire=86400&HW-CC-Sign=28CB39B961D0C22475722DDFB3877ADFDDEEB4ED46566C3235341EADEAF69F5A)
