...
**图1** 录制状态变化示意图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d5/v3/t4VTdAY3R3aCbXsiIlfYfA/zh-cn_image_0000002573974517.png?HW-CC-KV=V1&HW-CC-Date=20260421T111341Z&HW-CC-Expire=86400&HW-CC-Sign=81FF5766F4E9ACF7B7C6D044EBB57DD76743FE576C944A8EC0353614EF26617D)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e/v3/nFUG-SIwRIuu2AkM_mlzkw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111341Z&HW-CC-Expire=86400&HW-CC-Sign=59386286CADFD446685D7B069AD3512D2547A03E3DB238A2A87121BE14E5F9BD)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/17/v3/228s9VAkSNevBcDMXwnIBg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111341Z&HW-CC-Expire=86400&HW-CC-Sign=7BB0FEE774974DF85F76A7FF758AF6C9BF9DA0AD926AF8585E976911814F8E42)
配置参数需要注意：
-
...
```
5.
暂停录制，调用OH_AVRecorder_Pause()接口，此时AVRecorder进入paused状态，同时暂停输入源输入数据。
```
...
```
7.
停止录制，调用OH_AVRecorder_Stop()接口，此时进入stopped状态。
```
...
```
9.
销毁实例，调用OH_AVRecorder_Release()进入released状态，退出录制。
```
