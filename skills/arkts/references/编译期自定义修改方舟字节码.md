...
```
3.
在DevEco Studio中配置build-profile.json5的transformLib选项（以Windows环境为例）。
选项中配置的路径为步骤2生成的链接库文件在项目中的路径（这里是dll目录下）。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/2LLNJXHIRKGRN8-9bso_tA/zh-cn_image_0000002573973467.png?HW-CC-KV=V1&HW-CC-Date=20260421T110823Z&HW-CC-Expire=86400&HW-CC-Sign=7A3A7B0D8718500F661DBD25EBBE4BF40E321C60930EEC87C3B9F3FFB17169B9)
4.
