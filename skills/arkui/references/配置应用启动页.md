...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cb/v3/60Z-eIaoQE26ztKIp8KQCQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T110939Z&HW-CC-Expire=86400&HW-CC-Sign=F72EEC74CD46A1C6C5102FEDB49602DDDDEC41F42F16027F27953DD5C434F71D)
-
...
此时，默认启动页呈现示意图如下：
**图1** 默认启动页示意图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/cf/v3/mcmWp-EsT1GOzhMOIcc0_g/zh-cn_image_0000002543373896.png?HW-CC-KV=V1&HW-CC-Date=20260421T110939Z&HW-CC-Expire=86400&HW-CC-Sign=D2FE5C6D993633AD74A1C0A696DAD9C1ACAAB266BF28E39800F97BE73DC311A5)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/55/v3/_MNkFg8yQMaGIt2fGmrkIQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T110939Z&HW-CC-Expire=86400&HW-CC-Sign=04D727B16529DE92625D2650A9A7A827385D8E8C2A02A78B1C58657E592A82B5)
-
...
```
2.
配置二级json文件的具体字段。启动页资源主要在上、下两个区域进行展示，如果对应区域的资源未配置，则留空，其他区域的位置和尺寸不受影响。
具体可配置字段、各字段含义及增强启动页示意图请见下文。
| 字段 | 类型 | 是否可缺省 | 含义 |
| --- | --- | --- | --- |
| startWindowType | string | 是 | 标识当前UIAbility组件是否隐藏启动页。当前仅支持在2in1设备或平板设备的自由多窗模式下使用。不同取值含义如下：- "REQUIRED_SHOW"：强制显示启动页。不受[Ability管理服务（即StartOptions中hideStartWindow字段）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-startoptions#startoptions)的影响。- "REQUIRED_HIDE"：强制隐藏启动页。不受[Ability管理服务（即StartOptions中hideStartWindow字段）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-startoptions#startoptions)的影响。- "OPTIONAL_SHOW"：可选显示，默认行为为显示启动页，如果[Ability管理服务（即StartOptions中hideStartWindow字段）](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-app-ability-startoptions#startoptions)设置隐藏启动页，则隐藏启动页。- 如未配置该字段，默认取值为"REQUIRED_SHOW"，即强制显示启动页。从API version 20开始支持该字段。 |
...
**图2** 增强启动页示意图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/af/v3/EjfIl_R_QTOgNQn26SMqSw/zh-cn_image_0000002543214234.png?HW-CC-KV=V1&HW-CC-Date=20260421T110939Z&HW-CC-Expire=86400&HW-CC-Sign=C0014B4624530DEBE48525AA01A553A49960F7C4EA352DC48D018E01A28C28B0)
示例如下：
```json
{
