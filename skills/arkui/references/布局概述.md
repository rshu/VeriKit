...
**图1** 常见页面结构图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f4/v3/9UmOGnNPR9OeqlaqzLErKQ/zh-cn_image_0000002573973615.png?HW-CC-KV=V1&HW-CC-Date=20260421T110847Z&HW-CC-Expire=86400&HW-CC-Sign=BA4F45064A2D2A134842DAC60E840F2C227241F5FF2D384050AE351AE69F8388)
为实现上述效果，开发者需要在页面中声明对应的元素。其中，Page表示页面的根节点，Column/Row等元素为系统组件。针对不同的页面结构，ArkUI提供了不同的布局组件来帮助开发者实现对应布局的效果，例如Row用于实现线性布局。
#### 布局元素的组成
布局相关的容器组件可形成对应的布局效果。
**图2** 布局元素组成图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ca/v3/HTJjq2h8SB6JyMfNZNnOxQ/zh-cn_image_0000002543373386.png?HW-CC-KV=V1&HW-CC-Date=20260421T110847Z&HW-CC-Expire=86400&HW-CC-Sign=9A12E3C197650504DB1C9963ACCE1561AA3B63397C4A5E9484CA78C6D32D5EE1)
-
