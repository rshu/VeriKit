...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/OMj4wL2VRmS_x1ixLo8OUQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=464DB9EFD21349C1ADFC2547B4ABA19E8BE2CEAAB78485289EC64CA52B39279B)
...
运行效果如下图所示。
**LazyForEach正常首次渲染**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/19/v3/E4dQfWoqS9iTPqO11lOtaw/zh-cn_image_0000002573853597.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=04CD9EBEB9663733FBDDCC121EE6DAE2681C177FE3FFD618F9FDDBC0C49609D9)
**错误案例：键值相同导致渲染异常**
...
运行效果如下图所示。
**LazyForEach存在相同键值**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/61/v3/KxQG9RNZQ8KdxvBaiJg87A/zh-cn_image_0000002573973575.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=0E137A96D1311F9FBCFF8543D702D7A02C1640665752E8F82BEDF488DD8EEAF5)
...
修改后运行效果如下图所示。
**LazyForEach生成唯一键值**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/5a/v3/ZO4qMZmmSPW7zO_ifVL8Tw/zh-cn_image_0000002543373346.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=04FA527A4985F2F5AB5A85E78C3AB61D948B26652EF9520D530A335B427A53ED)
#### 数据更新
...
运行效果如下图所示。
**LazyForEach添加数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c3/v3/fCPa1KeJR8OpK1swtW9NJw/zh-cn_image_0000002543213686.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=E5266BDDB3B84F07307F1A32CD5AA0C807030C5ABA00EEE33294F66765A5C2DB)
**删除数据**
BasicDataSource代码见文档末尾BasicDataSource示例代码: [string类型数组的BasicDataSource代码](#string类型数组的basicdatasource代码) 。
```
import { hilog } from '@kit.PerformanceAnalysisKit';
...
运行效果如下图所示。
**LazyForEach删除数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/30/v3/-fmP91lnQIGNrahO9CMJCA/zh-cn_image_0000002573853599.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=9598C0C1A91260C8ABF260715788EDC720E8AA4996B486091D5976F9CAE35D56)
**交换数据**
BasicDataSource代码见文档末尾BasicDataSource示例代码: [string类型数组的BasicDataSource代码](#string类型数组的basicdatasource代码) 。
```
import { hilog } from '@kit.PerformanceAnalysisKit';
...
运行效果如下图所示。
**LazyForEach交换数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f5/v3/6UQ53tkKSnOpZqqvGqdNbg/zh-cn_image_0000002573973577.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=FB9FB0DB2556DEEE963A322EF5B5EF0D42BD3C91E6CB8F6E42A75CE15839BE9E)
**改变单个数据**
BasicDataSource代码见文档末尾BasicDataSource示例代码: [string类型数组的BasicDataSource代码](#string类型数组的basicdatasource代码) 。
```
import { hilog } from '@kit.PerformanceAnalysisKit';
...
运行效果如下图所示。
**LazyForEach改变单个数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8c/v3/gVwHnujMQa25jdH-I8_Q8g/zh-cn_image_0000002543373348.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=37D3709082397D14CF5C2AEA7BA5CD5612E9073D940F2245CF962FB406D48EF4)
**改变多个数据**
BasicDataSource代码见文档末尾BasicDataSource示例代码: [string类型数组的BasicDataSource代码](#string类型数组的basicdatasource代码) 。
```
import { hilog } from '@kit.PerformanceAnalysisKit';
...
运行效果如下图所示。
**LazyForEach改变多个数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/2e/v3/Pr7dGCdsSk6JI6NduYxwuw/zh-cn_image_0000002543213688.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=D82750CB6BE941B15B42F7360FEE15E84B42442A122AA4AEB570AF5D491897CD)
**精准批量修改数据**
BasicDataSource代码见文档末尾BasicDataSource示例代码: [string类型数组的BasicDataSource代码](#string类型数组的basicdatasource代码) 。
```
import { hilog } from '@kit.PerformanceAnalysisKit';
...
**LazyForEach改变多个数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/bb/v3/rH8VGVOIQk668Ei2y6-zCg/zh-cn_image_0000002573853601.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=95A0148942D69FA568FF76C5A41ADAF7472851332DF67E5BB5860D99C3582FC5)
...
```
**LazyForEach改变多个数据**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/YWO0b_A7TgaihzxfWr6dCg/zh-cn_image_0000002573973579.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=B18A63BADB3847158216F91F8F422F816186FC306BE59C073113A3BDD7F1E7C2)
使用该接口时请注意以下事项。
1.
...
**LazyForEach改变数据子属性**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/qxFgm7aVTQShRllxsBo4rw/zh-cn_image_0000002543373350.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=1DE4624EA03ED1C44DF9B048BD96BB48EDEBA200606CF686916327BCB49765FC)
#### 使用状态管理V2修改数据子属性
...
```
**LazyForEach拖拽排序效果图**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3f/v3/ZiENTsXAQTOlsDnVUph5Yw/zh-cn_image_0000002543213690.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=2A31AFFCFC0D88F3EA1DF52CE6F929B1BD4F8648848C2929CA45BA36B9F33D17)
#### 常见问题
#### 删除节点后渲染结果非预期
BasicDataSource代码见文档末尾BasicDataSource示例代码: [string类型数组的BasicDataSource代码](#string类型数组的basicdatasource代码) 。
```
...
```
**LazyForEach删除数据非预期**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/e3/v3/jGoLnJ_cQ5OwRReNY478IA/zh-cn_image_0000002573853603.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=190E7FB49A4999EE44F417B0FE9D0923067FFFEFBAFBC4929CC051E4F6A2971B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/40/v3/PsNwxZkXRgiFynU9KwNaVQ/zh-cn_image_0000002573973581.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=98576ECDB9234536A20106DF925F52175546268A3329F518B7C01CB380D00D21)
#### 重渲染时图片闪烁
GenericBasicDataSource代码见文档末尾BasicDataSource示例代码: [泛型数组的BasicDataSource代码](#泛型数组的basicdatasource代码) 。
```
// GenericBasicDataSource代码见文档末尾BasicDataSource示例代码: 泛型数组的BasicDataSource代码。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/FvwBT8jtS1yk6WFzBTtvrg/zh-cn_image_0000002543373352.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=D85245D894F5A1FD4FA368FCBF2B5D9908FBA9EB9805DA2056920367802F8F6B)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/ef/v3/tLcbobtORFC4O9yDYv0jNg/zh-cn_image_0000002543213692.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=56AAFC55E8B6FE6184E96C464DEA6F5B0E7C2684D2BC407DF3EDD8450283B5A3)
#### @ObjectLink属性变化UI未更新
GenericBasicDataSource代码见文档末尾BasicDataSource示例代码: [泛型数组的BasicDataSource代码](#泛型数组的basicdatasource代码) 。
```
// GenericBasicDataSource代码见文档末尾BasicDataSource示例代码: 泛型数组的BasicDataSource代码。
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/13/v3/kdJOUEy7Su6MN6VWl7uEWA/zh-cn_image_0000002573853605.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=0BDF438B08AE5F0E49C999FF773D7BED3CA302296ACF7C341F0DCE7C661F6764)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/db/v3/sXzCJb4iQ5mxCHy712LOGQ/zh-cn_image_0000002573973583.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=6A6DCAFE6C2F877416B57863B27C2F9161FDE860148B8AF32B037EDF30D86DA0)
#### 在List内使用屏幕闪烁
...
```
**当List下拉到底时，屏幕闪烁**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/91/v3/CiX5RR_ARZ-FwRDD_BGMJQ/zh-cn_image_0000002543373354.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=66259AF8CFA985F60C4FB33C2D8A6CD24AA39DA854D679435937957213EE9558)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b2/v3/5uD0-0fDSbKOIFHb2YgmcQ/zh-cn_image_0000002543213694.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=8AF37B72A58DD966D72085F289F0E2107D2A3E05421F89EA4F14C9D82434FB05)
#### 组件复用渲染异常
...
```
**点击按钮更新数据，组件不会刷新**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/1f/v3/5GZvxsVRQtaMLNZa62DR9Q/zh-cn_image_0000002573853607.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=72196AEE0B83C0507880C51E1FAEDD3328D836BB71CD4956BA133621AA7BAC92)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/0b/v3/vJwXp2JpR8S6U57qe3P1uQ/zh-cn_image_0000002573973585.gif?HW-CC-KV=V1&HW-CC-Date=20260421T110844Z&HW-CC-Expire=86400&HW-CC-Sign=49D211477FB1219BEF4CA57E6D3383FCF46B66B3283631150457A95F86A0566F)
#### 子组件尺寸缺失导致懒加载失效
