...
```
2.
配置输入文本框和按钮，调用分词 [textProcessing.getWordSegment](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/natural-language-text-processing-api#textprocessinggetwordsegment) 接口。
```typescript
