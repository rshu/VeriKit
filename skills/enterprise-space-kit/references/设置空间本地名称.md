...
```
2.
调用 [setWorkspaceLocalName](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setworkspacelocalname) 接口，设置工作空间本地名称，并且查看打印信息。
```typescript
