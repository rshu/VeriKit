...
```
2.
调用 [setWorkspaceStatusBarIcon](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setworkspacestatusbaricon) 接口，设置工作空间状态栏图标，并且查看打印信息。
```typescript
