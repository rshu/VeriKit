...
```
2.
调用接口 [getLockdownExemptionApps](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#getlockdownexemptionapps) ，查询深度冻结豁免名单，并且查看打印信息。
```typescript
