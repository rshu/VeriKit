...
```
2.
调用接口 [setRestrictedAccessBackgroundUserdata](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setrestrictedaccessbackgrounduserdata) ，设置系统服务进程不可访问后台用户数据的功能，并且查看打印信息。
```typescript
