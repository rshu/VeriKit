...
```
2.
调用 [setWorkspaceProfilePhoto](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/enterprisespace-spacemanager#setworkspaceprofilephoto) 接口，设置工作空间资料照片，并且查看打印信息。
```typescript
