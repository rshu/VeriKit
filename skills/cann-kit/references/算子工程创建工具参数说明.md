...
#### 命令汇总
执行如下命令，参数说明请参见表1。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/a3/v3/bw1Ui5SgQLqaBTo_52zs0w/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111720Z&HW-CC-Expire=86400&HW-CC-Sign=CFA92839B809DEA6C1FA4C9E890E38D91F97658567354188EAD1B9FC798B1637)
...
| input_desc | param_type | string | 参数类型：- required- optional- dynamic未配置默认为required。 | 否 |
...
| output_desc | param_type | string | 参数类型：- required- optional- dynamic未配置默认为required。 | 是 |
...
| attr | param_type | string | 参数类型：- required- optional未配置默认为required。 | 否 |
| attr | type | string | 算子参数的类型。包含如下取值：int、bool、float、string、list_int、list_float、list_bool，其他请参考[OpAttrDef](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/cannkit-opattrdef)进行修改。 | 否 |
