...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/52/v3/BkvHMQaURnCDjaPF41va4A/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111715Z&HW-CC-Expire=86400&HW-CC-Sign=273C5639D9FB1E682F7106866BD8A5FB82D8949ADC314CC3F2D791DAFD9E6120)
-
**调试工具暂不支持该配置** 。
-
...
| kernel_info**说明：**仅**核函数直调工程场景**需要设置kernel文件相关的配置。 | kernel_source | string | Kernel入口源文件绝对路径，注意格式是“绝对路径+文件名”。 | 根据开发的核函数信息填写。 | 是 |
