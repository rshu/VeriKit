...
-
[StorageOptions.network](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#storageoptions)
```typescript
...
```
-
[StorageOptions.mode](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/cloudfoundation-cloudcommon#storageoptions)
```typescript
import { cloudCommon } from '@kit.CloudFoundationKit';
import { request } from '@kit.BasicServicesKit';
// 设置云存储上传下载任务为前台模式
