...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/b9/v3/yqoTpJnOQCyZOXl_mZn3QQ/zh-cn_image_0000002543214706.png?HW-CC-KV=V1&HW-CC-Date=20260421T111408Z&HW-CC-Expire=86400&HW-CC-Sign=600DED1D3B7BA4F8CB011E431CFE5BAB0E5279A13FCBFA490330A92ECD0C2F00)
5.
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/20/v3/2dQQOSXCRu2Up7Rl-fFHjg/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111408Z&HW-CC-Expire=86400&HW-CC-Sign=70746C0B70BC0C8C334CFA1D68D978E0E475DE4619BB18FADB8106030C4FDFFF)
...
```
4.
创建一个文本样式对象，即OH_Drawing_TextStyle对象，用于设置文本样式。
```
OH_Drawing_TextStyle *textStyle = OH_Drawing_CreateTextStyle();
```
5.
[获取系统字体信息](#获取系统字体信息) ，获取系统字体的字体家族名，并在文本样式中设置为该系统字体。
```
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/86/v3/bf5OGImcRbuEmbh-0QDSQw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111408Z&HW-CC-Expire=86400&HW-CC-Sign=A487C52F308857DD07A95D2FC863632ABBD2E12080182C767ED212406D354398)
...
```
6.
创建文本样式对象，使用注册成功的自定义字体。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/27/v3/6nAv5yzyQlWhL21H8PkEEA/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111408Z&HW-CC-Expire=86400&HW-CC-Sign=F1FEC07F96E8F526CBE1559D98AABB5E7E02514C28D8D9484E690CE6A478E265)
