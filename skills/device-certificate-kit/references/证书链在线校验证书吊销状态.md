...
```
2.
调用 [cert.createX509CertChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatex509certchain11) 创建证书链对象。
3.
...
5.
调用 [cert.validate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#validate11) ，传入证书链校验参数，进行证书链校验。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/10/v3/cvz3JksXSlCh9ZaI11dSIQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111104Z&HW-CC-Expire=86400&HW-CC-Sign=F034211A6BF4B50E6860F9DB740CA79B0F72D6BFFE9C395360137B96FD596AAD)
...
```
2.
调用 [cert.createX509CertChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatex509certchain11-2) 创建证书链对象。
3.
