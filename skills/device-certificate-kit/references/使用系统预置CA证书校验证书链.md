...
```
2.
基于已有的证书数据，调用 [cert.createX509CertChain](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatex509certchain11) 创建X509证书链对象，并返回结果。
3.
