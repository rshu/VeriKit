...
```
2.
解析证书扩展域段数据，调用 [cert.createCertExtension](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/js-apis-cert#certcreatecertextension10) 创建证书扩展域段对象。
3.
