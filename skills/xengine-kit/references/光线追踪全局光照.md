...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/58/v3/GWJv8n3aQHiXdqSmNiPQbQ/zh-cn_image_0000002543214772.jpg?HW-CC-KV=V1&HW-CC-Date=20260421T111430Z&HW-CC-Expire=86400&HW-CC-Sign=72295EF3E626BDEB451CEB2BB5CE1D3C1D27534BA78370234C3D10E2489FC060)
...
3. 创建动态漫反射全局光照使用的创建信息，调用HMS_XEG_CmdRenderRTGI接口创建动态漫反射全局光照实例。
...
```
3.
调用 [HMS_XEG_CreateRTGI](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/xengine-kit-xengine#hms_xeg_creatertgi) 接口，创建RT DDGI实例。
```cpp
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c8/v3/JsnibvYQRYSjeTD5nL5gWA/zh-cn_image_0000002573854687.jpg?HW-CC-KV=V1&HW-CC-Date=20260421T111430Z&HW-CC-Expire=86400&HW-CC-Sign=EEF7DE94CEC41D5E18369C89E3F52C3E36F6B9E4CE1BF3C063442A02F3FB9AC7)
...
3. 创建神经网络全局光照使用的创建信息，调用HMS_XEG_CmdRenderRTGI接口创建神经网络全局光照实例。
...
```
3.
调用 [HMS_XEG_CreateRTGI](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/xengine-kit-xengine#hms_xeg_creatertgi) 接口，创建RT NNGI实例。
```cpp
// Vulkan逻辑设备，用户需进行初始化
VkDevice device;
// XEG_DDGICreateInfo为创建XEG_RTGI对象所需信息
