...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9e/v3/i7DICb9IQX-ZkYjfa2I0Ag/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=1177F406BD085E238AFCBE0FDB854DFA0271427296C0074D86B991C75E313D4E)
...
| --- | --- | --- | --- |
| 堆栈采集 | 150ms < 主线程处理时长 < 450ms | 文件名格式：MAIN_THREAD_JANK_秒级时间_进程PID.txt。例如：MAIN_THREAD_JANK_20240613211739_40986.txt。 | -**应用启动10s内不进行检测。**-**关闭[开发者选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-developer-mode#section0736139111917)：应用在一个生命周期内，一天最多触发一次主线程超时事件堆栈采集流程。**-**启用[开发者选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-developer-mode#section530763213432)：应用在一个生命周期内，一小时最多触发一次主线程超时事件采集堆栈采集流程。** |
| trace采集 | 主线程处理时长 > 450ms | 文件名格式：MAIN_THREAD_JANK_unix时间戳_进程PID.trace。例如：MAIN_THREAD_JANK_1762064185461_40986.trace。 | - 触发trace采集的前提：**开发者使用[nolog](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/performance-analysis-kit-terminology#nolog版本)版本，并且关闭[开发者选项](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-developer-mode#section530763213432)**。-**应用一天内，最多触发一次主线程超时事件trace采集流程。** |
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/6d/v3/2oj3BocURECdGvF9sL3UZQ/caution_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=213A7CB7C0208566428E75A53C3A78C42B99ED2129770E8FC7033B26C3B554D8)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/26/v3/abczI_tdSymn49nOuoaxWA/zh-cn_image_0000002543374186.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=5B99A46E234D582D80A74F318FC276365DB6BDE7F379C45DBC31B0264A70FE24)
（2）第1轮未检测到主线程处理超时（主线程处理时长 > 150ms），第2轮检测到主线程处理超时（主线程处理时长 > 150ms），开始执行堆栈采集流程，每隔150ms采集1次，共采集10次堆栈，第12轮收集堆栈并上报事件，结束检测。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/28/v3/RWBf9OlvTn2geu09_y1h1w/zh-cn_image_0000002543214524.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=E5FEE70F6FC94EA2999BCB474769A15829434A867A8C76D82DEDB93FC4D6A3F4)
（3）前2轮均未检测到主线程处理超时（主线程处理时长 > 150ms），结束检测。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9a/v3/sdmwUXm7ThSVKl2GQoIpqQ/zh-cn_image_0000002573854439.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=950C9E3E38FF2CA824D93B1F5AB92E520FEDAB091243D18930FA62EB4AF5333C)
2.
trace采集流程
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/c/v3/xDVhEu7lQ_mj7NjODoIfwQ/zh-cn_image_0000002573974415.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=18349E14795DC4B9596EDCA0E8EBFB552F19D1F5704EA681609EB093DC68A898)
（2）20轮检测至少有一轮检测发生主线程处理超时（主线程处理时长 > 150ms），生成trace文件并上报事件，结束检测。
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/31/v3/JARExiLeQxCnZ5TBEU06kw/zh-cn_image_0000002543374188.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=E071635B62096A0874E612C0E4CCD4E20AE0D4F599AABF1E7B5EC28415D56217)
#### 日志获取
...
检测原理如下图：
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/MIQUd41CT3KDKPnHSUBOwg/zh-cn_image_0000002543214526.png?HW-CC-KV=V1&HW-CC-Date=20260421T111238Z&HW-CC-Expire=86400&HW-CC-Sign=EC6BA9524E69ED92D0BC62F921675E5F90F60623CD62EED4E4553470097975B3)
#### 日志获取
任务执行超时日志可通过以下方式获取：
**通过HiAppEvent接口订阅**
