...
**图1** ：基础离线编辑示意图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/37/v3/oqbpcMW_SXGtD3or0r8PJA/zh-cn_image_0000002543374230.png?HW-CC-KV=V1&HW-CC-Date=20260421T111305Z&HW-CC-Expire=86400&HW-CC-Sign=3615E38322C1E5973443D66EF7D02C8F5042529A88881271DB5FD0731C6DC12A)
1.
创建引擎和管线。
```cpp
// 创建引擎。
...
**图2** ：音源分离编辑示意图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/3e/v3/we9qqlj8RwC7W9gr3E3Lyw/zh-cn_image_0000002543214568.png?HW-CC-KV=V1&HW-CC-Date=20260421T111305Z&HW-CC-Expire=86400&HW-CC-Sign=4939ABADAFCE067B82D93D32D58917DA789A8722275052F5D0A658CC2F2E92D0)
示例代码如下：
1.
创建引擎和管线。
```cpp
...
**图3** ：级联编辑示意图
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/82/v3/-J6K-PdcRmKRgtnfGNDq4g/zh-cn_image_0000002573854483.png?HW-CC-KV=V1&HW-CC-Date=20260421T111305Z&HW-CC-Expire=86400&HW-CC-Sign=D457367E7C854225975881F43CCB2C980725B72AA5AC21ECCF781976922CF604)
示例代码如下：
1.
创建引擎和管线。
```cpp
