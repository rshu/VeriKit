...
```
3.
调用 [attributionTestManager.flushPostbacks](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-attributiontestmanager#attributiontestmanagerflushpostbacks) 方法触发归因结果回传。
```typescript
