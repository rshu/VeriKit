...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/18/v3/NdfQlYvRRQu2Vdiq44Yfhw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111450Z&HW-CC-Expire=86400&HW-CC-Sign=9D113C6955050808D0EB32BEB224AF5971BEC1B6FCAFA2CF258725606ADAB962)
...
```
2.
使用应用归因服务提供的公钥，对步骤1拼接的字符串进行验签，验签方法可参考 [回传结果验签方法](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-rest-receive#回传结果验签方法) 。
应用归因服务提供的公钥：
```typescript
-----BEGIN PUBLIC KEY-----
