...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/78/v3/b4T19pzaSiCRStVah7LYcA/zh-cn_image_0000002543374474.png?HW-CC-KV=V1&HW-CC-Date=20260421T111448Z&HW-CC-Expire=86400&HW-CC-Sign=38E0A7C30FFDA398117198BA58847EA74EEF96D4151CE0E8004CD132985035A6)
#### 业务流程
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/48/v3/4U74SM8dR2eR_aNJOxtUBQ/zh-cn_image_0000002543214812.png?HW-CC-KV=V1&HW-CC-Date=20260421T111448Z&HW-CC-Expire=86400&HW-CC-Sign=7BF00A9AC7E48377757872AAAF8D9906A77B2FA4E587F45430A03CEE53104F18)
1.
应用调用检查更新接口。
2.
升级服务API返回是否有新版本。
...
```
3.
调用 [checkAppUpdate](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-updatemanager#updatemanagercheckappupdate) 方法检查应用版本是否有更新。
```typescript
try {
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/fc/v3/NY8WpNEGT-6yZZDqJ1ylrA/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111448Z&HW-CC-Expire=86400&HW-CC-Sign=B82AB620E005FEF27D770CA826E9ABA3F3E147A82DC5BCDD1F63D94034412A57)
-
...
```
3.
调用 [showUpdateDialog](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/store-updatemanager#updatemanagershowupdatedialog) 方法显示升级对话框。
```typescript
try {
