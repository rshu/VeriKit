...
Exif（Exchangeable image file format）是专门为数码相机的照片设定的文件格式，可以记录数码照片的属性信息和拍摄数据。当前支持JPEG、PNG、HEIF、WEBP 23+ 、DNG 23+ 格式，且需要图片包含Exif信息。
...
**读取和编辑图片Exif信息接口使用示例**
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/wCRRPMKFSzmiCfGzp-WYXQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111334Z&HW-CC-Expire=86400&HW-CC-Sign=8495849BE7CD40F9C4DC51DAC46349E405C169FCE967D1F15030E22EF47DAE92)
...
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/57/v3/WLoDLOONSn2msweAeTnGdQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111334Z&HW-CC-Expire=86400&HW-CC-Sign=065F1CA381A108899D63C177792B3BDE4C4582C4C261ADEEFA8CF0C1024EC5E4)
