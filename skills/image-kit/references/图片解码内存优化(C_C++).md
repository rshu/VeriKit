...
1. 调用[OH_PixelmapNative_GetImageInfo](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-pixelmap-native-h#oh_pixelmapnative_getimageinfo)方法，获取 OH_Pixelmap_ImageInfo 对象。
2. 调用[OH_PixelmapImageInfo_GetRowStride](https://developer.huawei.com/consumer/cn/doc/harmonyos-references/capi-pixelmap-native-h#oh_pixelmapimageinfo_getrowstride)方法，获取stride的值。
...
```
![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/9d/v3/nv0xoB21RQqaVbHMHj6MoQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260421T111332Z&HW-CC-Expire=86400&HW-CC-Sign=3DC9F42874E1554A6E76A75E482D7EBFF1D33EC035FBFE9A9C543CF2464A675E)
